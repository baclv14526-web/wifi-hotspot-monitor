...
class HotspotMonitorService : LifecycleService() {
    ...
    private fun performCheck() {
        ...
        nm.notify(FOREGROUND_NOTIFICATION_ID, buildForegroundNotification(isHotspotOn))
    ...
    private fun sendHotspotOffAlert() {
        val settingsIntent = createHotspotSettingsIntent()
        val settingsPi = PendingIntent.getActivity(
            this, 100, settingsIntent,
            PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT
        )
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID_ALERT)
            ...
            .addAction(R.drawable.ic_wifi_hotspot, "Bật Hotspot", settingsPi)
            .addAction(R.drawable.ic_settings, "Mở App", appPi)
            .setAutoCancel(false)
